...
import { getPublishedBlog, getPublishedBlogs, normalizeBlogImageSources, renderBlogDocument } from '@/lib/blog';
...
export default async function Article({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="w-full">
      ...
      <iframe
        title={blog.title}
        srcDoc={normalizeBlogImageSources(renderBlogDocument(blog.body, blog.customCss))}
