...
export type TripCartItem = { key: string; slug: string; title: string; category: 'STAY' | 'RIDE' | 'RENTAL' | 'ACTIVITY'; price: number; startDate: string; endDate?: string; pickup?: { location: string; detail: string; requestedTime: string }; addons?: string[] };
